export function DashHeader(page) {
    return `
      <nav class="bg-light navbar navbar-main navbar-expand-lg position-sticky mt-2 top-0 px-0 mx-4 shadow-none border-radius-xl z-index-sticky" id="navbarBlur" data-scroll="true">
